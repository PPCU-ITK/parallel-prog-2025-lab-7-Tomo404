...
int main(){
    ...
    #pragma omp target data map(rho[0:total_size], rhou[0:total_size], rhov[0:total_size], E[0:total_size], solid[0:total_size]) \
    ...
    auto duration = std::chrono::duration<double>(end_timer - begin_timer);
